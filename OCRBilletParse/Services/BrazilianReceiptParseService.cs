...
using OCRBilletParse.Model;
using System.Text;

namespace OCRBilletParse.Services
{
    public class BrazilianReceiptParseService : IBrazilianImageRecognitionParseService
    {
        public BillTotalParseModel Parse(string imageText) 
        {
